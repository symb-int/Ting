...
function SocialLoginRender({
      ...
      <SocialButton
        ...
        Icon={() =>
          startupConfig.openidImageUrl ? (
            <img src={startupConfig.openidImageUrl} alt="" aria-hidden="true" className="h-5 w-5" />
          ) : (
            <OpenIDIcon />
          )
        }
      ...
      <SocialButton
        ...
        Icon={() =>
          startupConfig.samlImageUrl ? (
            <img src={startupConfig.samlImageUrl} alt="" aria-hidden="true" className="h-5 w-5" />
          ) : (
            <SamlIcon />
          )
        }
  ...
  return (
    <div className="ting-auth-social">
      {startupConfig.emailLoginEnabled && (
        <p className="text-center text-sm leading-[1.45] text-text-secondary">
