...
export const MOBILE_DRAWER_FULL_WIDTH = 'min(280px, 100vw)';
export const MOBILE_DRAWER_STRIP_WIDTH = MOBILE_DRAWER_FULL_WIDTH;
export const MOBILE_DRAWER_WIDTH = `var(${MOBILE_DRAWER_WIDTH_VAR}, ${MOBILE_DRAWER_FULL_WIDTH})`;
export const MOBILE_PANE_SHIFT = 'none';
