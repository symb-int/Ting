...
const SearchBar = forwardRef((props: SearchBarProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  return (
    <div
      ref={ref}
      className="ting-sidebar-search group relative flex h-9 min-w-0 flex-1 cursor-pointer items-center gap-3 text-text-primary"
    >
      <Search
        aria-hidden="true"
      ...
      <input
        ...
        aria-label={localize('com_ting_search_cases')}
        aria-keyshortcuts={focusSearchAriaKey}
        placeholder={localize('com_ting_search_cases')}
        onKeyUp={handleKeyUp}
