  ...
  return (
    ...
    >
      ...
      <OGDialogContent overlayClassName="ting-dialog-backdrop" className="dialog">
        ...
        <div className="dialog__body flex flex-col items-center justify-center">
          {image != null ? (
            <>
              <div
                className={cn(
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-3">
                    <TingIconButton
                      ...
                      disabled={scale <= 1}
                      label={localize('com_ui_zoom_out')}
            ...
            <div
              className="flex h-72 w-full flex-col items-center justify-center rounded-[5px] border border-dashed border-border-medium bg-transparent p-4"
              onDrop={handleDrop}
        ...
        {image != null && (
          <div className="dialog__foot">
            ...
            <TingButton
              ...
              disabled={isUploading}
            >
              {isUploading ? <Spinner className="icon-sm" /> : <Upload aria-hidden="true" />}
