    ...
    <OGDialog open={isDialogOpen} onOpenChange={setDialogOpen}>
      <div className="flex items-center justify-between">
        ...
        <OGDialogTrigger asChild>
          <TingButton aria-label={localize('com_ui_manage')} variant="secondary" size="compact">
      ...
      <OGDialogContent overlayClassName="ting-dialog-backdrop" className="dialog">
        <OGDialogHeader className="dialog__head">
          <OGDialogTitle>{localize('com_ui_backup_codes')}</OGDialogTitle>
        </OGDialogHeader>
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {user?.backupCodes.map((code, index) => {
                      ...
                      const description = getBackupCodeDescription(code, index, localize);
