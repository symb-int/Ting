      ...
      <OGDialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        ...
        >
          <OGDialogHeader className="dialog__head">
            <OGDialogTitle>{localize('com_ui_delete')}</OGDialogTitle>
          </OGDialogHeader>
          <div id={deleteDescriptionId} className="dialog__body break-words">
            <Trans
          ...
          <div className="dialog__foot">
            <OGDialogClose asChild>
              <TingButton type="button" variant="secondary" size="compact">
