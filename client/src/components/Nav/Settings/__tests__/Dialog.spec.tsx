...
describe('SettingsDialog', () => {
  ...
  it('marks both transition layers for reduced-motion overrides', () => {
    render(<SettingsDialog open onOpenChange={jest.fn()} />);

    expect(document.querySelector('.ting-settings-dialog-transition--backdrop')).toHaveClass(
      'ting-settings-dialog-transition',
    );
    expect(document.querySelector('.ting-settings-dialog-transition--panel')).toHaveClass(
      'ting-settings-dialog-transition',
    );
  });
