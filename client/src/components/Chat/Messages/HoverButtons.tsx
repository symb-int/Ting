...
type THoverButtons = {
  ...
  isLast: boolean;
  index: number;
  /** Kept in the native component contract; I01 does not expose feedback controls. */
...
const HoverButtons = ({
  ...
  return (
    <div className="group visible flex justify-center gap-0.5 self-end focus-within:outline-none lg:justify-start">
      ...
      {/* Feedback is disabled by the I01 interface configuration. Keeping the
          native path here preserves LibreChat's underlying capability. */}
      {!message.error &&
        !isActiveStreamingMessage &&
        !isCreatedByUser &&
        handleFeedback != null && (
