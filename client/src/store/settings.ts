...
const localStorageAtoms = {
  ...
  maximizeChatSpace: atomWithLocalStorage('maximizeChatSpace', false, () => false),
  chatDirection: atomWithLocalStorage('chatDirection', 'LTR', () => 'LTR'),
   ...
   */
  collapseLongUserMessages: atomWithLocalStorage('collapseLongUserMessages', false, () => false),
  /**
   ...
   */
  pasteLongTextAsFile: atomWithLocalStorage('pasteLongTextAsFile', false, () => false),
  ...
  centerFormOnLanding: atomWithLocalStorage('centerFormOnLanding', true, () => true),
  /**
   ...
   */
  mobileDrawerStrip: atomWithLocalStorage('mobileDrawerStrip', false, () => false),
  showFooter: atomWithLocalStorage('showFooter', true),

  // Commands settings
  atCommand: atomWithLocalStorage('atCommand', false, () => false),
  plusCommand: atomWithLocalStorage('plusCommand', false, () => false),
  slashCommand: atomWithLocalStorage('slashCommand', false, () => false),
  dollarCommand: atomWithLocalStorage('dollarCommand', false, () => false),

  // Speech settings
  conversationMode: atomWithLocalStorage('conversationMode', false),
  advancedMode: atomWithLocalStorage('advancedMode', false),

  speechToText: atomWithLocalStorage('speechToText', false, () => false),
  ...
  textToSpeech: atomWithLocalStorage('textToSpeech', false, () => false),
