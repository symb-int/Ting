...
function DataTable<TData extends Record<string, unknown>, TValue>({
  ...
  return (
    ...
    >
      {showToolbar && (
        <div className="flex w-full shrink-0 items-center gap-2 border-b border-border-light pr-2 min-[800px]:gap-3">
                  ...
                  if (isSelectHeader) {
                    ...
                    headerContent = (
                      <Button
                        type="button"
                        variant="ghost"
                        className="group h-auto w-full justify-start gap-1 px-0 py-0 text-xs font-medium uppercase tracking-wide text-text-secondary hover:bg-transparent hover:text-text-primary min-[800px]:gap-1.5"
                  ...
                  return (
                    <TableHead
                      ...
                      className={cn(
                        ...
                        'sticky top-0 z-10 h-9 border-b border-border-light bg-surface-dialog px-3 py-2 min-[800px]:px-4',
                        isSelectHeader && 'px-0 text-center',
                        canSort && 'cursor-pointer',
                        meta?.className,
                        header.column.getIsResizing() && 'bg-surface-tertiary/60',
                        isDesktopOnly && 'hidden min-[800px]:table-cell',
                      )}
                      style={widthStyle}
                      aria-sort={ariaSort}
                    >
